...
local function get_groups()
    ...
    local groups = {
        ...
        DiagnosticVirtualTextError = { fg = colors.red, bg = "#3c1f1f" },
        DiagnosticVirtualTextWarn = { fg = colors.yellow, bg = "#3c3022" },
        DiagnosticVirtualTextInfo = { fg = colors.blue, bg = "#1f2c28" },
        DiagnosticVirtualTextHint = { fg = colors.aqua, bg = "#1f2c28" },
